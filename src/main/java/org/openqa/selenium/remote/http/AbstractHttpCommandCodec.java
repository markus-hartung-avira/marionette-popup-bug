...
public abstract class AbstractHttpCommandCodec implements CommandCodec<HttpRequest> {
  ...
  public AbstractHttpCommandCodec() {
    ...
    // Set Context for firefox
    defineCommand(MOZ_GET_CONTEXT, get("/session/:sessionId/moz/context"));
    defineCommand(MOZ_SWITCH_TO_CONTEXT, post("/session/:sessionId/moz/context"));
